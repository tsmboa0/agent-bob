...
Your response should be in this proper json format please: {recommender_response}

The user data is: {msgs}
Your suggestions to the user should be from our dataset found here: 
...
Your response should be in this proper json format please: {investor_response}
...
Your response should be in this proper json format please: {collector_response}
...
Your final response should be in this proper json format please: {socializer_response}
...
Your final response should be in this proper json format please: {wishlist_response}
